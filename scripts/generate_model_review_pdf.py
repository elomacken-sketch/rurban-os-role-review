...
SCREENS = [
    ("老板页面", "这个月项目怎么样？", "默认打开，先看项目总结、四项目标、当前问题和要决定的事。", "screenshots/views/owner-overview.png"),
    ("老板页面", "目标详情", "点击“已投入测试”，查看实际、目标、差距、变化、原因和下一步。", "screenshots/views/owner-metric-detail.png"),
    ("老板页面", "本周报告", "点击本周情况，打开已经完成、还没完成和下一步。", "screenshots/views/owner-weekly-report.png"),
    ("老板页面", "问 AI", "追问第一轮测试为什么还没开始，查看根据当前项目数据给出的回答。", "screenshots/views/owner-ai-answer.png"),
    ("运营页面", "今天要做什么？", "查看今天的待办、负责人、完成日期和还缺的资料。", "screenshots/views/operations-today.png"),
    ("运营页面", "本月怎么安排？", "查看发布日期、活动、需要的资料和确认时间。", "screenshots/views/operations-calendar.png"),
    ("运营页面", "要发布什么内容？", "切换平台并查看准备好的内容。", "screenshots/views/operations-content.png"),
    ("招商页面", "接下来应该联系谁？", "查看已经联系的品牌、还缺什么和下一步。", "screenshots/views/leasing-overview.png"),
    ("招商页面", "适合联系哪些品牌？", "查看适合的品牌类型、为什么适合和联系前要确认什么。", "screenshots/views/leasing-candidates.png"),
    ("招商页面", "可以发送什么材料？", "查看适合的铺位和目前可以发送的介绍材料。", "screenshots/views/leasing-ammo.png"),
    ("招商页面", "商户参加得怎么样？", "查看参加商户、要做的事、完成日期和提交情况。", "screenshots/views/leasing-merchants.png"),
    ("本月商户任务", "产品和价格", "第一步：提交这个月确定销售的产品、价格和推荐理由。", "screenshots/views/merchant-step-1.png"),
    ("本月商户任务", "图片和故事", "第二步：上传原图并填写具体的品牌或产品故事。", "screenshots/views/merchant-step-2.png"),
    ("本月商户任务", "选择参加方式", "第三步：选择可以参加的内容、活动和账号转发。", "screenshots/views/merchant-step-3.png"),
    ("填写本月变化", "选择本月目标", "第一步：选择这个月最想先解决的事情。", "screenshots/views/input-step-1.png"),
    ("填写本月变化", "选择最重要的人群", "第二步：选择这个月最想影响的人。", "screenshots/views/input-step-2.png"),
    ("填写本月变化", "选择最多花多少钱", "第三步：选择这个月最多准备花多少钱。", "screenshots/views/input-step-3.png"),
    ("填写本月变化", "选择先做哪件事", "第四步：选择先把人和时间用在哪件事上。", "screenshots/views/input-step-4.png"),
    ("填写本月变化", "填写新情况", "第五步：只填写这个月新发生的变化。", "screenshots/views/input-step-5.png"),
]
